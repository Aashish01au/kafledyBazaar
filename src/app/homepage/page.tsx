        ...
        <div className="w-[25%] ">
          ...
          <div className="bg-white shadow-sm rounded-sm mt-5">
            ...
            <div className="flex gap-3 p-2">
              <Image className="w-[86px] h-[63px]" src={fruits1} alt="fruits" />
              <div className="p-3">
                Custard apple
                <p>
                  {" "}
            ...
            <div className="flex gap-3 p-2">
              <Image className="w-[86px] h-[63px]" src={fruits4} alt="fruits" />
              <div className="p-3">
                Custard apple
                <p>
                  {" "}
            ...
            <div className="flex gap-3 p-2">
              <Image className="w-[86px] h-[63px]" src={fruits2} alt="fruits" />
              <div className="p-3">
                Custard apple
                <p>
                  {" "}
            ...
            <div className="flex gap-3 p-2">
              <Image className="w-[86px] h-[63px]" src={fruits3} alt="fruits" />
              <div className="p-3">
                Custard apple
                <p>
                  {" "}
          ...
          <div className="bg-white shadow-sm rounded-sm mt-5">
            ...
            <div className="flex">
              <div className="items-center gap-3 p-2">
                <Image className='w-[210px] h-[145px]' src={fruits1} alt="fruits3" />
              ...
              <div className="items-center gap-3 p-2">
                <Image className='w-[210px] h-[145px]' src={fruits2} alt="fruits3" />
                <div className="p-3 text-center">
                  Custard apple
                  <p>
                    {" "}
              ...
              <div className="items-center gap-3 p-2">
                <Image className='w-[210px] h-[145px]' src={fruits3} alt="fruits3" />
                <div className="p-3 text-center">
                  Custard apple
                  <p>
                    {" "}
